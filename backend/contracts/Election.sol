...
contract Election {
    ...
    function setElectionDetails(string memory _name, string memory _description, string memory _time)
        public
        onlyAdmin
    {
        name = _name;
   ...
   function getElectionTime() public view returns (string memory) {
        return time;
    }
